...
export default function Home() {
  ...
  return <main>
    ...
    <footer id="about"><div className="brand footer-brand"><span className="brand-mark">KI</span><span>KOLLYWOOD<br/>INDEX</span></div><p className="disclaimer"><strong>Information and attribution</strong><br/>This site uses the TMDB API but is not endorsed or certified by TMDB. Film information, posters and images come from The Movie Database. Kollywood Index is an independent, non-commercial cultural discovery and commentary project. It has no affiliation with any studio, distributor, critic, Reddit or Letterboxd. Artwork and trademarks remain with their respective owners.</p><p className="copyright">© {new Date().getFullYear()} Kollywood Index<br/>A clearer way to explore Tamil cinema.</p></footer>
  </main>;
}
